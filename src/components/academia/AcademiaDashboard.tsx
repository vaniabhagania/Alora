            ...
            {activeCourses.map((course) => {
              ...
              return (
                <button
                  ...
                  className="group flex items-center gap-3 rounded-xl border border-ink/8 bg-ink/[0.02] p-3 text-left transition-all hover:border-ink/15 hover:bg-ink/[0.04]"
                >
        ...
        {deadlines.length === 0 ? (
          ...
          <div className="space-y-2">
            {deadlines.map((task) => {
              ...
              return (
                <div key={task.id} className="flex items-center gap-3 rounded-lg border border-ink/8 bg-ink/[0.02] px-3 py-2">
