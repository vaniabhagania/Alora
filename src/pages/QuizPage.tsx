        ...
        <div className="glass-card mb-6 p-6">
          ...
          {q.question_type === 'mcq' && q.options.length > 0 ? (
                ...
                <button
                  ...
                  className={`w-full rounded-xl border px-4 py-3 text-left text-sm transition-all ${
                    answers[currentQ] === opt
                      ...
                      : 'border-ink/10 bg-ink/[0.02] text-[var(--text-secondary)] hover:border-ink/15 hover:text-[var(--text-primary)]'
                  }`}
                >
                  {opt}
                </button>
            ...
            <textarea
              ...
              rows={4}
              className="w-full rounded-xl border border-ink/10 bg-ink/[0.03] px-4 py-3 text-sm text-[var(--text-primary)] placeholder:text-[var(--text-secondary)]/50 focus:border-[var(--accent)]/50"
            />
          )}
        </div>
        <div className="flex justify-between">
          {currentQ > 0 ? (
            <button onClick={() => setCurrentQ((prev) => prev - 1)} className="rounded-xl border border-ink/10 px-5 py-2.5 text-sm font-medium text-[var(--text-secondary)] hover:bg-ink/5">Previous</button>
          ) : <div />}
